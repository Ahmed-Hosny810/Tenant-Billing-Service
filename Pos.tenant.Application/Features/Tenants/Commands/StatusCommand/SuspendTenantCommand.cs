...
{
    public class SuspendTenantCommand : IRequest<Result<Guid>>
    {
        public Guid TenantId { get; set; }
        public string? Reason { get; set; }
    }
    
    public class SuspendTenantCommandHandler : IRequestHandler<SuspendTenantCommand, Result<Guid>>
    {
        ...
        public SuspendTenantCommandHandler(ITenantRepositoryAsync tenantRepository, ITenantStatusHistoryRepositoryAsync tenantStatusHistoryRepository,IUnitOfWork unitOfWork)
        {
            _tenantRepository = tenantRepository;
            _tenantStatusHistoryRepository = tenantStatusHistoryRepository;
            _unitOfWork = unitOfWork;
        }
        public async Task<Result<Guid>> Handle(SuspendTenantCommand request, CancellationToken cancellationToken)
        {
